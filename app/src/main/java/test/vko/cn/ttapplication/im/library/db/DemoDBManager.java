package test.vko.cn.ttapplication.im.library.db;
...
import test.vko.cn.ttapplication.TTapplication;
import test.vko.cn.ttapplication.im.library.Constant;
import test.vko.cn.ttapplication.im.library.model.EaseUser;
import test.vko.cn.ttapplication.im.library.model.InviteMessage;
import test.vko.cn.ttapplication.im.library.model.RobotUser;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(TTapplication.getInstance().getApplicationContext());
    }
